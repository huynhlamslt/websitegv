...
//     this.state = {
//     }
//     this.handdleSubmit = this.handleSubmit.bind(this);
...
//             <input type="button" onClick={this.handleClick} className="fadeIn fourth login-btn" value="Log In"/>
//           </form>
